...
try{ %>
	...
	<div id="registerMsg">
		<table border="0">
			<tr valign="top">
				<td colspan="2"><h2>Referrer Registration</h2></td>
			</tr>
			<tr id="regrow_userId">
				<td>Desired Referrer ID <span class="redtext">*</span></td>
				<td>
					<input type="text" id="reg_userId" maxlength="32" size="30"></input>
					<input type="hidden" id="help_userId" value="Referrer ID: Supports alphanumeric, hyphen and underscore characters only."></input>
				</td>
			</tr>
			<tr>
				<td></td>
			...
			<tr id="regrow_businessType">
				<td colspan="2">
					<input type="hidden" id="reg_businessType" value="<%=Constants.REFERRER%>"></input>
			...
			<tr height="80">
				<td colspan="2" align="center"><input id="submitButton" type="button" value="Register Referrer" disabled style="color: #999" onclick="registerUser()"></input></td>
			</tr>
		</table>
	</div><%
}finally{

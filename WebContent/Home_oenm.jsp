                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <%
                                                String[][] nm = {
                                                                    {"wcn.jpg","World Chambers Network<br>Global B2B Market","","www.wcnmarket.com"},
                                                                    {"watradehub.jpg","Exporters from 10 West African<br>Countries - Promo","","network.africancraft.com/"},
                                                                    {"Lifestyle.jpg","LifeStyle 2010 Vietnam<br>B2B Trade Show","","lifestyle.openentry.com"},
                                                                    {"SBA.jpg","American SME<br>B2B Exporters from USA","","www.americansme.com"},
                                                                    
                                                                    {"fhan.jpg","Federation of Handicraft Associations<br>of Nepal - B2B","","www.nepalhandicraftmarket.com"},
                                                                    {"bcc.jpg","Barbados Chamber of Commerce<br>and Industry - Promo","","bcc.openentry.com"},
                                                                    {"FHH.jpg","FromHerHands.com B2C<br>Women Artists Worldwide","","www.fromherhands.com"},
                                                                    {"expro88.jpg","Expro88 Pipe and Process<br>Equipment - B2B","","expro88.openentry.com"},

                                                                    {"mesh.jpg","MESH - Leprosy Affected <br/> Artisans in India - Promo","","mesh.openentry.com"},
                                                                    {"Nyigf-design.jpg","NY International Gift Show<br>Promo","","75.101.165.126/nyigf-design"},
                                                                    {"mcc.jpg", "Mexico City Chamber<br>of Commerce - B2B","","mcc.openentry.com"},
                                                                    {"ftf.jpg","TrueFairTrade.com - Certified<br>Fair Trade Retailers in USA","","www.truefairtrade.com"},

                                                                    {"wfto.jpg","World Fair Trade Organization","","www.wftomarket.com"},
                                                                    {"lccimarket.jpg","Lahore Chamber of Commerce and Industry","","lccimarket.OpenEntry.com"},
                                                                    {"southasia.jpg", "Regional Market of the Cluster<br>of South Asian Chambers ","","southasia.openentry.com"},
                                                                    {"nty2011.jpg","Nepal Tourism Year 2011 NM","","www.nepaltourismyear2011.info"}
                                                                };
                                                int n = 0;
                                                for(int i=1; i<=4; i++){%>
                                                <tr valign="top">
                                                    <% for(int j=1; j<=4; j++){%>
                                                        <td>
                                                            <div align="center">
                                                                <img class="thumb" alt="" title="Click to show image!" src="/images/oedan/nm/<%= nm[n][0]%>" border="0" width="200" height="200" 
										onclick="plainBox.showTooltip(event,'load:nm<%=n%>',1);" 
										onMouseOver="plainBox.showTooltip(event,'load:nm<%=n%>',0);"
									 	/>
                                                                <div align="center" style="padding-top:5px"><a target="_blank" href="<%= nm[n][3].equals("")?("http://"+Constants.OE_URL+"/"+nm[n][0].substring(0, nm[n][0].length()-4)):("http://"+nm[n][3]) %>?refid=openentry"><u><%= nm[n][1] %></u></a></div>
                                                                <div align="center" style="padding-top:5px"><%= nm[n][2] %></div>
                                                            </div>
                                                            <div id="nm<%=n%>" style="display:none; position:absolute; z-index:2;">
                                                                    <img class="thumb" alt="" title="Click to hide image!" src="/images/oedan/nm/<%= nm[n][0] %>" border="2" />
                                                            </div>
                                                        </td><%
                                                        n++;
                                                    }%>
                                    ...
                                    <tr>
                                        <td colspan="2" align="right">
                                            <div style="padding-right:5px"><a href="http://nm.openentry.com/openentry/Buyers?singlePageTemplate=true&pagesize=96"><b><u>More Network Markets ...</u></b></a><br /></div>
                                        </td>
                                    </tr>
                                </table>
                            <% }
								...
								--%>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <%
                                                            if(catgenContext.PageName.equals("Catalog")||catgenContext.PageName.equals("Catalogs")){%>
                                                                <p style="text-align:center"><b>Sample Free Catalogs</b></p>
                                                                <table align="center" width="100%" border="0" cellspacing="5" cellpadding="5">
                                                                <%
                                                                    String[][] catalogs = {
                                                                                                {"apdk.jpg","Kenya",""},
                                                                                                ...
                                                                                                {"kwanza.jpg","Tanzania",""},
                                                                                                {"mereville.jpg","India",""},
                                                                                                {"pup.jpg","Bangladesh","pupbd.org"},
                                                                                                {"nature.jpg","Nepal","www.naturenepalhs.com"},
                                                                                                {"Jamel.png","Haiti","Catalog.OpenEntry.com/JacmelArtNCraft"},
                                                                                                {"sipaonline.jpg","India",""},
                                                                                                {"dealercatalog.jpg","USA",""},
                                                                                                {"village.png","Burkina Faso","catalog.openentry.com/villageartisanal"},
                                                                                                {"tradeaid.jpg","Ghana",""},
                                                                                                {"trinityjewelcrafts.jpg","Kenya",""},
                                                                                                {"twcnepal.jpg","Nepal",""}
                                                                                          };
                                                                    int n = 0;
                                                                    for(int i=1; i<=4; i++){%>
                                                                    <tr valign="top">
                                                                        <% for(int j=1; j<=4; j++){%>
                                                                            <td>
                                                                                <div align="center">
                                                                                    <img class="thumb" alt="" title="Click to show image!" src="/images/oedan/catalogs/<%= catalogs[n][0]%>" border="0" width="200" height="200" onclick="ShowPopup('oe<%=n%>');" onMouseOver="ShowBiggerImage('oe<%=n%>');" onMouseOut="ShowDefaultImage('oe<%=n%>');" />
                                                                                    <div align="center" style="padding-top:5px"><a target="_blank" href="<%= Constants.OE_URL %>/openentry/ReferralEvent.html?refid=testdref&companycode=<%= catalogs[n][0].substring(0,catalogs[n][0].length()-4) %>&type=refer&url=<%= catalogs[n][2].equals("")?("http://main.openentry.com/"+catalogs[n][0].substring(0,catalogs[n][0].length()-4)):("http://"+catalogs[n][2]) %>"><u><%= catalogs[n][1] %></u></a></div>
                                                                                </div>
                                                                                <div id="oe<%=n%>" style="display:none; position:absolute; z-index:2;">
                                                                                        <img class="thumb" alt="" title="Click to hide image!" src="/images/oedan/catalogs/<%= catalogs[n][0] %>" border="2" onclick="HidePopup('oe<%=n%>');" />
                                                                                </div>
                                                                            </td><%
                                                                            n++;
                                                                        }%>

...
try{
	...
	UserSessionBean userSessionBean = UserSessionFactory.getUserSessionBeanByIdAndType(conn, networkMarket.NetworkMarketID, 
			Constants.NETWORK_MARKET);
	...
	TemplatePropertiesBean templatePropertiesBean = TemplateInitializer.initializeTemplateProperties(
			catgenContext, conn, networkMarket.NetworkMarketID);
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            .thumbnailContent {
                width: <%= isMSIE?style.thumbnailWidthInPixels:(style.thumbnailWidthInPixels + 10) %>px;
            ...
            .thumbnailImage {
                ...
                max-height: <%= style.thumbnailHeightInPixels -15%>px;
            ...
            body{
                <%= StyleFactory.getBackgroundStyle(style.screenBackgroundImage, style.screenBackgroundColor, style.screenBackgroundRepeat,
                		Constants.DEFAULT_BG_COLOR_BODY)%>
            ...
            .page{
                width: 1024px;
                <%= StyleFactory.getBackgroundStyle(style.pageBackgroundImage, style.pageBackgroundColor, style.pageBackgroundRepeat, 
                		Constants.DEFAULT_BG_COLOR_PAGE)%>
            }
            ...
            .NavBar{
                height: 32px;
                <%= StyleFactory.getBackgroundStyle(style.navbarBackgroundImage, style.navbarBackgroundColor, style.navbarBackgroundRepeat,
                		Constants.DEFAULT_BG_COLOR_NAVBAR)%>
            }

            #NavBarText a{
                font-weight:bold;
                <%= StyleFactory.getFontStyle(style.navbarFont, style.navbarFontSize, style.navbarFontColor,
                		Constants.DEFAULT_FONT_COLOR_NAVBAR)%>
            ...
            .Title{
                ...
                font-weight:bold;
                height:32px;
                <%= StyleFactory.getBackgroundStyle(style.titlebarBackgroundImage, style.titlebarBackgroundColor, 
                		style.titlebarBackgroundRepeat, Constants.DEFAULT_BG_COLOR_TITLE)%>
                <%= StyleFactory.getFontStyle(style.titlebarFont, style.titlebarFontSize, style.titlebarFontColor,
                		Constants.DEFAULT_FONT_COLOR_TITLE)%>
            ...
            .categoryBackground{
                <%= StyleFactory.getBackgroundStyle(style.categoryBackgroundImage, style.categoryBackgroundColor, 
                		style.categoryBackgroundRepeat, Constants.DEFAULT_BG_COLOR_CATEGORY) %>
            }
            .categoryTitle{
                padding-left: 10px;
                padding-top: 10px;
                margin-bottom: 1px; 
                font-weight: bold;
                <%= StyleFactory.getBackgroundStyle(style.categoryTitleBackgroundImage, style.categoryTitleBackgroundColor,
                		style.categoryTitleBackgroundRepeat, Constants.DEFAULT_BG_COLOR_CATEGORYTITLE) %>
                <%= StyleFactory.getFontStyle(style.categoryTitleFont, style.categoryTitleFontSize, style.categoryTitleFontColor, 
                		Constants.DEFAULT_FONT_COLOR_CATEGORYTITLE) %>
        	  height: 25px;
            }
            .categoryList{
                height: 25px;
                ...
                padding-top: 10px;
                margin-bottom:1px;
                <%= StyleFactory.getBackgroundStyle(style.categoryListBackgroundImage, style.categoryListBackgroundColor, 
                		style.categoryListBackgroundRepeat, Constants.DEFAULT_BG_COLOR_CATEGORYLIST) %>
                <%= StyleFactory.getFontStyle(style.categoryListFont, style.categoryListFontSize, style.categoryListFontColor, 
                		Constants.DEFAULT_FONT_COLOR_CATEGORYLIST) %>
            }
            .hoverList{
                height: 25px;
                padding-left: 10px;
                padding-top: 10px;
                margin-bottom:1px;
                <%= StyleFactory.getBackgroundStyle(style.categoryHoverBackgroundImage, style.categoryHoverBackgroundColor, 
                		style.categoryHoverBackgroundRepeat, Constants.DEFAULT_BG_COLOR_HOVERLIST) %>
                <%= StyleFactory.getFontStyle(style.categoryHoverFont, style.categoryHoverFontSize, style.categoryHoverFontColor, 
                		Constants.DEFAULT_FONT_COLOR_HOVERLIST) %>
            }
        </style>
    ...
    <body>
        <table style="table-layout:fixed;width: 1024px;border-collapse:
collapse;" class="page" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td align="center">
                   <a href="<%= catgenContext.RelativePath%>Home.html?singlePageTemplate=true&pagesize=<%=catgenContext.PageSize%>">
                        <div id="homeAnchor">
                            <table width="1024px" border="0" align="left" cellpadding="0" cellspacing="0">
                                <tr>
            ...
            <tr>
                <td align="left" valign="middle">
                    <table style="table-layout:fixed;width: 1024px;border-collapse:
collapse;"  border="0" cellpadding="0" cellspacing="0" class="NavBar">
                        <tr>
                            <td width="60%" align="left" valign="middle">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr align="left">
                                        <td id="NavBarText">&nbsp;&nbsp;&nbsp;
                                            <a href="<%= catgenContext.RelativePath%>Home.html?singlePageTemplate=true&pagesize=
                                            <%=catgenContext.PageSize%>"><%= style.homeText%></a> <a>|</a>
                                            <a href="<%= catgenContext.RelativePath%>Vendors.html?singlePageTemplate=true&pagesize=
                                            <%=catgenContext.PageSize%>"><%= style.vendorsText%></a> <a>|</a>
                                            <%
                                            if (templatePropertiesBean.mtPages != null && templatePropertiesBean.mtPages.size() > 0) {
                                                for (Page mtPage : templatePropertiesBean.mtPages) {
                                                	if(!mtPage.Hidden){%>
                                            			<a href="<%= catgenContext.RelativePath%>
                                            			<%= URLEncoder.encode(Utils.getSafeString(mtPage.Name).trim())%>?
                                            			singlePageTemplate=true&pagesize=<%=catgenContext.PageSize%>">
                                            			<%= StringEscapeUtils.escapeHtml(mtPage.Name)%></a> <a>|</a> <%
                                                	}
                                                }
                                            }%>
                                            <a href="<%= catgenContext.RelativePath%>Feedback.html?singlePageTemplate=true&pagesize=
                                            <%=catgenContext.PageSize%>">Feedback</a> <a>|</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="category" id="category"><%
                                                	if(catgenContext.searchCategory!=null && catgenContext.searchCategory.length()>0){%>
                                                		<option value = '<%=catgenContext.searchCategory%>'>
                                                		<%=CategoryFactory.getCategoryNameByCategoryKeyFromXml(conn,catgenContext.searchCategory)%>
                                                		</option>
                                                	<%}%>
                                            ...
                                            <%}else{ %>
                                            	<td>
                                            		Category:&nbsp;<%=(catgenContext.searchCategory!=null && catgenContext.searchCategory.length()>0)?
                                            				CategoryFactory.getCategoryNameByCategoryKeyFromXml(
                                            						conn,catgenContext.searchCategory):"All"%>&nbsp;&nbsp;
                                            						<input type="hidden" name="category" 
                                            						value="<%=(catgenContext.searchCategory!=null && 
                                            								catgenContext.searchCategory.length()>0)?catgenContext.searchCategory:""%>">
                                            								</input>
                                            	</td>
                                            <%}
                                                ...
                                                <select name="pricerange" id="pricerange">
                                                    <option value="1" >Any Price</option><%
                                                     for (PriceRange pr : templatePropertiesBean.priceRanges) {
                                                         if (pr.value != 1) {%>
                                                    <option value="<%=pr.value%>" <% if (catgenContext.priceRangeCode == pr.value) {%>
                                                    selected<% }%>><%=pr.display%></option><%
                                                         }
                                                     }%>
                                                </select>
                                            </td>
                                            <%}%>
                                            <td><input type="text" name="search" id="search" size=15 onclick = "this.value=''" 
                                            value="<%= style.defaultSearchText%>"/></td>
                                            <td><input name="imageField" type="image" id="imageField" src="<%= style.searchButtonImageURL%>"
                                             align="top" /></td>
                                        </tr>
                                    </table>
                                </form>
            ...
            <tr>
                <td>
                    <table style="table-layout:fixed;width: 1024px;border-collapse:
collapse;" border="0" cellpadding="0" cellspacing="0" align="center">
                        <tr>
                        <%
                        ...
                        <td class="categoryBackground" valign="top" width=<%=Constants.CATEGORY_COLUMN_WIDTH %>><%
	                        List<Category> categories = CategoryHelper.getRootCategories(conn,networkMarket.NetworkMarketID);
	                		String html="<div class=\"multidiv\"><ul id=\"multitree1\">";
					        html+="<li id=\"allcategory\" class=\"categoryTitle\"><a href=\""+catgenContext.RelativePath+"Search.html?category=&pagesize="+
					        		catgenContext.PageSize+"&singlePageTemplate=true&test=correct&pricerange=1\">All Categories</a></li>";
					        for(Category category: categories){
	                			//html+=CategoryHelper.getoneRecursiveHTML(conn,category.categoryKey,networkMarket.NetworkMarketID);
	                			html+=CategoryHelper.getoneRecursiveHTML1(conn,category.categoryKey,networkMarket.NetworkMarketID,category.categoryValue);
	                		}
	                		html+="</ul></div>";
	                		html = html.replaceAll(Constants.RELATIVE_PATH, catgenContext.RelativePath);%>
	                		<%=html %>    
                        </td>
                        <%}%>
                        <td valign="top" width="<%= Constants.CONTENT_PANEL_WIDTH %>px" style="width: <%= Constants.CONTENT_PANEL_WIDTH %>px;">
                            <%
                            if ("Home".equalsIgnoreCase(catgenContext.PageName)) {%>
                                <table style="table-layout:fixed;width: <%= Constants.CONTENT_PANEL_WIDTH %>px;border-collapse:
collapse;" border="0" cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        <td>
                                    ...
                                    <tr valign="middle">
                                        <td>
                                            <table style="table-layout:fixed;width: <%= Constants.CONTENT_PANEL_WIDTH %>px;border-collapse:
collapse;"  border="0" cellpadding="0" cellspacing="0" class="Title">
                                                <tr>
                                                    <td>
                                    ...
                                    <tr valign="top" align="left">
                                        <td><%
                                           if (templatePropertiesBean.networkMarketFeaturedProducts != null && 
                                        		   templatePropertiesBean.networkMarketFeaturedProducts.size() > 0) {
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;<%= style.keywordText + ": "%><%=(catgenContext.Search != null) ?
                                                        		catgenContext.Search : ""%><br />
                                                            &nbsp;&nbsp;&nbsp;&nbsp;<%= style.categoryText + ": "%>
	                                                        <a style="text-decoration: none; background-color: orange; padding: 2px;" 
	                                                        href="<%= catgenContext.RelativePath%>Search.html?category=&pagesize=<%=catgenContext.PageSize%>
	                                                        &singlePageTemplate=true&test=correct&pricerange=1&search=">All Categories</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<%
	                                                        String catKey = catgenContext.searchCategory;
	                                                        String origin = Constants.XML_CATEGORY_ROOT_KEY;
	                                                        catKey = (catKey!=null)?catKey:origin;
	                                                        List<Category> categories = CategoryHelper.getRootCategories(conn, networkMarket.NetworkMarketID);
	                                                        for(Category category: categories){
	                                                        	if(category.categoryKey!=null && category.categoryKey.length()>0 && catKey.contains
	                                                        ...
	                                                        if(CategoryFactory.isValidXmlCategoryKey(conn, catKey)){
		                                                        for(int i=origin.length();i<=catKey.length();i+=Constants.CHARS_PER_CATEGORY){%>
																	<a style="text-decoration: none; background-color: lime; padding: 2px;" 
																	href="<%= catgenContext.RelativePath%>Search.html?category=<%=catKey.substring(0,i)%>
																	&pagesize=<%=catgenContext.PageSize%>&singlePageTemplate=true&test=correct&pricerange=1">
																	<%=CategoryFactory.getCategoryNameByCategoryKeyFromCategory(conn,catKey.substring(0,i),networkMarket.NetworkMarketID) %>
																	</a>&nbsp;&gt;&nbsp; 
																<%} 
															}%>
                                                        ...
                                                        <% if (style.includeCountrySearch) {%>
                                                        	&nbsp;&nbsp;&nbsp;&nbsp;<%= style.countryText + ": "%><%= (catgenContext.searchCountry != null) ?
                                                        			catgenContext.searchCountry : ""%> <br />
                                                        <%}%>
                                                    </td>
                                                    <td align="right">
                                                        <%@ include file = "/common/addthis.jsp" %>
                                        ...
                                        <td>
                                            <div class="contents">
                                                <table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;&nbsp;&nbsp;<%=rowno%></td>
                                                        <td>&nbsp;<%if (templatePropertiesBean.trustedCompanies.get(comp.Code) != null) {%>
                                                        <img src="<%= style.trustSealImageURL%>"></img><%}%>&nbsp;</td>
                                                        <td><a href="<%= companyURL%>" target="_blank"><%= StringEscapeUtils.escapeHtml(comp.Name)%></a></td>
                                                        <td>&nbsp;&nbsp;<%= StringEscapeUtils.escapeHtml((comp.Country!=null && 
                                                        		comp.Country.length()>0)?comp.Country:"---")%></td><%
                                                        int pCount = ProductFactory.getVendorProductCount(conn, comp.Code);
                                                        totalPCount+=pCount;%>
                                                        <td><a href="<%= URLEncoder.encode(comp.Code, "UTF-8")%>
                                                        /Products.html?singlePageTemplate=true&pagesize=<%=catgenContext.PageSize%>">
                                                        <%=pCount%>&nbsp;<%= style.productsText%></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
                                                            <hr size="1"/>
                            ...
                            <%
                            	...
                            	<table border="0" cellpadding="0" cellspacing="10" align="center"><%
                            		...
                            		<tr>
                            			<td colspan="2" align="center">You can use this form to send message to the Network Market
                            			 <%=(networkMarket.Name!=null)?networkMarket.Name:"" %>.</td>
                            		</tr>
                            		<tr height="20">
                            			<td colspan="2"></td>
                            		</tr>
                            		...
                            		<tr>
                            			<td colspan="2" align="left"><br/><br/><br/><%
		                            		...
		                            		try{
			                            		...
			                            		mailObj.body = "Mail From: "+from+
			                            		"(Click on the Email ID to reply)\n\n\n-----------------------------------------------------------------------------------\n"+message;
			                            		new MailerThread(mailObj).sendMail();
...
collapse;" border="0" cellpadding="0" cellspacing="0" align="center">
                                    <tr>
                                        <td>
                                            <table style="table-layout:fixed;width: <%= Constants.CONTENT_PANEL_WIDTH %>px;border-collapse:
collapse;" border="0" align="center" cellspacing="5" cellpadding="2"><%
                                                int n = 1;
                                                int rowNumber = 0;
                                				...
                                				for (Product product : displayProducts) {
			                            			if(product!=null){
	                                                    ...
	                                                    String productURL = Utils.getReferralURL(catgenContext.RelativePath, 
	                                                    		catgenContext.ReferralID, company.Code, "product,marketfeatured,home",
	                                                    		Utils.getProductURL(company, product, catgenContext.RelativePath, catgenContext.ReferralID), product.Code);
	                                                    ...
	                                                    if (product.ImageURL != null && product.ImageURL.length() > 0) {
	                                                        ...
	                                                        <tr valign="top" align="center"><%}%>
	                                                            <td width="<%= style.thumbnailWidthInPixels%>px;" class="thumbnailContent">
	                                                                <table style="table-layout:fixed;width: <%= style.thumbnailWidthInPixels + 15%>px;border-collapse:
collapse;background:<%= style.thumbnailBackgroundColor%>;" height="100%" align="center" cellpadding="5" cellspacing="0" border="0">
	                                                                    <tr>
	                                                                ...
	                                                                <%}%>
	                                                                    ...
	                                                                    <tr>
	                                                                        <td width="<%= style.thumbnailWidthInPixels%>px;" height="80%" align="center" valign="middle">
	                                                                    ...
	                                                                    <table bgcolor="#CCCCCC" border="5" bordercolor="#35557C" cellpadding="5px" cellspacing="0">
	                                                                        <tr>
	                                                                            <td valign="top" align="center">
	                                                                                <div style="width:320px"><img src="<%=product.ImageURL%>" 
	                                                                                class="largeImage" height="240px" /></div>
	                                                                            </td>
	                                                                        ...
	                                                                        <tr>
	                                                                         ...
	                                                                         <img class="thumbnailImage" src="<%=product.ImageURL%>" border="0" onError="img2txt(this)"
                                  			...
                                  			title="Click to fix the popup image!" />
	                                                                    ...
	                                                                    <tr>
	                                                                        <td height="10%" align="center" valign="top">
	                                                                            ...
	                                                                            <img src="<%= style.orderButtonImageURL%>" width="40" height="14" border="0" /></a>
	                                                                        </td>
	                                                                    </tr>
	                                                                </table>
	                        ...
	                        <%--<td class="categoryBackground" valign="top" width=<%=Constants.CATEGORY_COLUMN_WIDTH %>>
	                            ...
	                            for (Category cat : templatePropertiesBean.categories) {
	                                if("".equals(cat.categoryKey)){%>
	                                    ...
	                                    <a href="<%= catgenContext.RelativePath%>Search.html?category=<%=cat.categoryKey%>
	                                    &pagesize=<%=catgenContext.PageSize%>&singlePageTemplate=true&test=correct&pricerange=1">
	                                        <div id='<%=cat.categoryKey%>' class="categoryList" 
	                                        onmouseover="this.className = 'hoverList';" onmouseout="this.className = 'categoryList';">
	                                            <%=cat.categoryValue%>
	                                        </div>
	                                    </a><%
	                              	}
        ...
        <p align="center">
            <a href="http://www.openentry.com">Powered by OpenEntry using the latest cloud 
            computing technology on Google and Amazon tools and servers</a>
        </p>
        <% if(networkMarket.GoogleAnalytics != null && networkMarket.GoogleAnalytics.length() > 0){%>
        	<script type="text/javascript">
			  var _gaq = _gaq || [];
			  _gaq.push(['_setAccount', '<%= networkMarket.GoogleAnalytics %>']);
